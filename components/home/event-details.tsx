...
import { EVENT_DATES, VENUE_MAP_URL } from "@/lib/config"
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className={`rounded-3xl ${SURFACE[tone]} p-10`}>
        ...
        <div className="text-center mt-8">
          ...
          {phase === "open" && (
            <>
              <WaitlistNote initialPhase={phase} onDark={tone === "dark"} className="mx-auto mt-3" />
              <WaitlistDeadline
                initialPhase={phase}
                colorClassName={`text-sm ${MUTED[tone]}`}
                className="mt-2"
              />
            </>
          )}
