...
export const TIERS: Record<Tier, TierConfig> = {
  ...
  silver: {
    ...
    recommendsInvoice: false,
    benefits: [
      `Logo on the event t-shirt (for sponsors committed by ${SPONSOR_DEADLINE_SHORT})`,
      "Sponsor booth or table",
    ],
    repCount: 2,
  ...
  gold: {
    ...
    benefits: [
      ...
      "Short speaking slot",
      "Mentor teams onsite",
      `Sponsor a challenge prompt or prize category (for sponsors committed by ${SPONSOR_DEADLINE_SHORT})`,
    ],
    repCount: 4,
